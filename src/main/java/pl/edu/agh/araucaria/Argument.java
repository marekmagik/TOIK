 ...
 * pl.edu.agh.araucaria.Argument.java
 *
...
public class Argument {
    ...
    /**
     * Creates a new instance of pl.edu.agh.araucaria.Argument
     */
    public Argument() {
        try {
    ...
    private TreeVertex freeListContainsVertexID(String id) {
        for (int i = 0; i < freeVertexList.size(); i++) {
            ...
            if (vertex.getShortLabel().equals(id)) {
                return vertex;
            }
        }
        return null;
    ...
    public String writeXML() {
        try {
            ...
            // pl.edu.agh.araucaria.Argument tree
    ...
    public void standardToWigmore() {
        ...
        for (int i = 0; i < vertexList.size(); i++) {
            ...
            if (vertex.isRefutation() && !((String) vertex.roles.get("wigmore")).contains("evidence")) {
    ...
    public void standardToToulmin() {
        ...
        // create a pl.edu.agh.araucaria.TreeVertex to represent them in Toulmin.
        for (int i = 0; i < vertexList.size(); i++) {
            TreeVertex vertex = (TreeVertex) vertexList.elementAt(i);
...
//            currentParent);
    ...
    /**
     * Returns a Vector of pl.edu.agh.araucaria.TreeVertex containing all vertices selected
     */
    ...
    /**
     * Returns a Vector of pl.edu.agh.araucaria.TreeEdge containing all selected edges
     */
