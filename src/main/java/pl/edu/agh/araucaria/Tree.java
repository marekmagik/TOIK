...
/**
 * Extends the pl.edu.agh.araucaria.Graph class to construct a tree out of pl.edu.agh.araucaria.TreeVertex objects
 */
...
public class Tree extends Graph
    ...
    /**
     * Adds a pl.edu.agh.araucaria.TreeVertex object to the list of vertices.
     */
    ...
    public Vector breadthFirstTraversal(TreeVertex start) throws GraphException {
        if (!m_vertexList.contains(start)) {
            throw new GraphException(
                    "pl.edu.agh.araucaria.Tree.breadthFirstTraversal: Starting vertex not found in graph: " + start.getShortLabelString());
        }
        int startIndex = m_vertexList.indexOf(start);
     ...
     * @return a Vector containing the sorted list of pl.edu.agh.araucaria.Vertex objects.
    ...
    public Vector breadthFirstTopSort(TreeVertex start) throws GraphException {
        ...
        if (!m_directed) {
            throw new GraphException(
                    "pl.edu.agh.araucaria.Graph is undirected - topological sort applies only to directed graphs.");
        }
        if (!m_vertexList.contains(start)) {
        ...
        if (vertexQueue.size() == 0)
            throw new GraphException("pl.edu.agh.araucaria.Graph has a cycle.");
