...
public class Araucaria extends JFrame implements ControlFrame {
    ...
    public static String mainFrameTitle = "main.java.Araucaria 3.1 ";
    ...
    // Main GUI components
    private final int ARAU_HEIGHT = 650;
    private final int ARAU_WIDTH = 900;
    ...
    private DisplayFrame[] displays;
    private int diagramStyle = DIAGRAM_STANDARD;
    private int zoomState = ZOOM_FULLTEXT;
    public JMenuItem undoMenuItem = new JMenuItem();
    public JMenuItem redoMenuItem = new JMenuItem();
    // Tutoring menu
    public JMenu tutorMenu = new JMenu();
    // Edit toolbar
    public JButton undoToolBar = new JButton();
    public JButton redoToolBar = new JButton();
    public JPanel messagePanel = new JPanel();
    private Stack recentTextFiles, recentAmlFiles, recentSchemeFiles;
    // Required as a class field since caption changes
    private Action showOwnersAction = new FileActionHandler("");
    private Action showEvaluationAction = new FileActionHandler("");
    // File dialog stuff
    private JFileChooser fileChoice, amlChoice, schemeChoice, tiffChoice;
    private File lastDirectory, araucariaHome;
    private File currentOpenXMLFile = null;
    // Database objects
    private Connection dbConnection;
    private Statement statement;
    private SearchFrame searchFrame = new SearchFrame(this, false);
    private RegistrationDialog registrationDialog = new RegistrationDialog(this);
    private LoginDialog loginDialog = new LoginDialog(this);
    private String loggedInUser = null;
    private boolean doComboEvents = false;
    ...
    private JPanel toulminPanel = new JPanel();
    private JPanel wigmorePanel = new JPanel();
    private CardLayout standardCard = new CardLayout();
    private CardLayout toulminCard = new CardLayout();
    private CardLayout wigmoreCard = new CardLayout();
    private Font menuFont = new Font("Sansserif", Font.PLAIN, 12);
    private ExtensionFileFilter extFilter = new ExtensionFileFilter();
    private ExtensionFileFilter jpgFilter = new ExtensionFileFilter("jpg", "JPEG Images");
    private ExtensionFileFilter tifFilter = new ExtensionFileFilter("tif", "TIFF Images");
    private String[] nodeBeliefs = {"Doubt", "Belief", "Strong belief", "Disbelief", "Strong disbelief"};
    ...
    private JScrollPane selectTextScroll;
    ...
    private JMenuItem openTextMenuItem = new JMenuItem();
    private JMenuItem openArgumentMenuItem = new JMenuItem();
    private JMenuItem saveArgumentMenuItem = new JMenuItem();
    private JMenuItem saveAsArgumentMenuItem = new JMenuItem();
    private JMenuItem saveDiagramMenuItem = new JMenuItem();
    ...
    private JMenuItem clearDiagramMenuItem = new JMenuItem();
    private JMenuItem flipDiagramMenuItem = new JMenuItem();
    private JMenuItem missingPremiseMenuItem = new JMenuItem();
    private JMenuItem refutationMenuItem = new JMenuItem();
    private JMenuItem deleteMenuItem = new JMenuItem();
    private JMenuItem linkMenuItem = new JMenuItem();
    private JMenuItem unlinkMenuItem = new JMenuItem();
    private JMenuItem selectAllMenuItem = new JMenuItem();
    // View menu
    private JMenu viewMenu = new JMenu();
    private JMenu zoomMenu = new JMenu();
    private JMenuItem scaledMenuItem = new JMenuItem();
    private JMenuItem fullSizeMenuItem = new JMenuItem();
    private JMenuItem fullTextMenuItem = new JMenuItem();
    private JMenu styleMenu = new JMenu();
    private JMenuItem standardMenuItem = new JMenuItem();
    private JMenuItem toulminMenuItem = new JMenuItem();
    private JMenuItem wigmoreMenuItem = new JMenuItem();
    private JMenuItem pollockMenuItem = new JMenuItem();
    // Labels menu
    private JMenu labelsMenu = new JMenu();
    private JMenuItem modifyOwnershipMenuItem = new JMenuItem();
    private JMenuItem showOwnersMenuItem = new JMenuItem();
    private JMenuItem modifyEvaluationMenuItem = new JMenuItem();
    private JMenuItem showEvaluationMenuItem = new JMenuItem();
    // Schemes menu
    private JMenu schemesMenu = new JMenu();
    private JMenuItem selectSchemeMenuItem = new JMenuItem();
    private JMenuItem addEditSchemeMenuItem = new JMenuItem();
    private JMenuItem openSchemesetMenuItem = new JMenuItem();
    private JMenuItem saveSchemesetMenuItem = new JMenuItem();
    // AraucariaDB menu
    private JMenu araucariaDBMenu = new JMenu();
    private JMenuItem loginMenuItem = new JMenuItem();
    private JMenuItem registerMenuItem = new JMenuItem();
    private JMenuItem saveDBMenuItem = new JMenuItem();
    private JMenuItem searchDBMenuItem = new JMenuItem();
    private JMenuItem premiseEndpointsMenu = new JMenuItem();
    private JMenuItem markingMenu = new JMenuItem();
    // Help menu
    ...
    private JButton openTextToolBar = new JButton();
    private JButton openArgumentToolBar = new JButton();
    private JButton saveArgumentToolBar = new JButton();
    private JButton saveDiagramToolBar = new JButton();
    private JButton clearDiagramToolBar = new JButton();
    private JButton flipDiagramToolBar = new JButton();
    private JButton missingPremiseToolBar = new JButton();
    private JButton refutationToolBar = new JButton();
    private JButton deleteToolBar = new JButton();
    private JButton linkToolBar = new JButton();
    private JButton unlinkToolBar = new JButton();
    // Scheme toolbar
    private JButton selectSchemeToolBar = new JButton();
    // Database toolbar
    private JButton saveDBToolBar = new JButton();
    private JButton searchDBToolBar = new JButton();
    private JComboBox searchResultCombo;
    // Help toolbar
    private JButton helpToolBar = new JButton();
    ...
    /**
     * Creates new form main.java.Araucaria
     */
    public Araucaria() {
        createIcon(this);
     ...
     * <p/>
     * Assumed that these files are in the same directory as the main.java.Araucaria class files.
     */
    public static boolean processArgs(String[] args) {
        // If no args, start main.java.Araucaria as a GUI application
        ...
        //tutorFilename = main.java.Araucaria.amlDirectory + File.separator + tutorFilename;
    ...
    private void loadRecentFiles() {
        try {
            ...
            objStream.close();
        } catch (Exception ex) {  // If we get an error, redefine recentFiles.dat from defaults
    ...
    private void initComps() {
        ...
        //
        mainToolBar.setBorder(new BevelBorder(BevelBorder.RAISED));
        ...
        // Text panel
        //
        selectTextScroll.setHorizontalScrollBarPolicy(JScrollPane.HORIZONTAL_SCROLLBAR_NEVER);
        selectTextScroll.setViewportBorder(new BevelBorder(BevelBorder.RAISED));
    ...
    public void openTextFile() {
        ...
        try {
            ...
            if (fileChoice.showOpenDialog(Araucaria.this) ==
                ...
                if (!chosenFile.getPath().contains(".txt")) {
    ...
    public void saveImageFile() {
        ...
        if (tiffChoice.showSaveDialog(this) ==
            ...
            if (chosenFile.getPath().contains(".tif")) {
                imageType = IMAGE_TIF;
            } else if (chosenFile.getPath().contains(".jpg")) {
                imageType = IMAGE_JPG;
            } else {
                FileFilter selectedFilter = tiffChoice.getFileFilter();
                if (selectedFilter == jpgFilter) {
                    ...
                    chosenFile = new File(newPath);
                } else { // If All files chooser is selected, default to a tif file
                    imageType = IMAGE_TIF;
                    String newPath = chosenFile.getPath() + ".tif";
                    chosenFile = new File(newPath);
                }
    ...
    public void saveTiffFile(BufferedImage image, File chosenFile) {
        ...
        try {
            ImageIO.write(image, "tiff", chosenFile);
    ...
    public void saveJpegFile(BufferedImage image, File chosenFile) {
        ...
        try {
            ...
            ImageIO.write(image, "jpg", chosenFile);
    ...
    public void checkNewNegatory(Vector wigEdges) {
        ...
        while (nodeEnum.hasMoreElements()) {
            ...
            if (vertex.getSupportLabel() == null) continue;
            if (!vertex.isVirtual() && !vertex.previousRefutation && vertex.isRefutation()) {
                ...
                opposite.getIsHiddenTable().put("toulmin", "true");
                opposite.getIsHiddenTable().put("wigmore", "true");
    ...
    public void doOpenSchemeset() {
        ...
        try {
            ...
            if (schemeChoice.showOpenDialog(this) ==
                ...
                if (!chosenFile.getPath().contains(".scm")) {
...
//    searchFrame.updateSchemesetSearchCombo();
        ...
        try {
            ...
            if (schemeChoice.showSaveDialog(Araucaria.this) ==
                ...
                try {
                    ...
                    String outString = argument.writeSchemeset();
    ...
    private ConnectionConfig displayLoginDialogAndBuildConfig() {
        loginDialog.setOkPressed(false);
        loginDialog.show();
        while (!loginDialog.isOKPressed()) {
            try {
                Thread.sleep(1000);
        ...
        String username = loginDialog.getUsernameTextField().getText();
...
*/
        ConnectionConfig connectionConfig = displayLoginDialogAndBuildConfig();

        String username = loginDialog.getUsernameTextField().getText();
        String password = null;

        try {
            if (dao.doLogin(connectionConfig, username, password)) {
                setMessageLabelText("User " + username + " logged in.");
    ...
    public boolean doRegister() {
        ...
        try {
            ...
            connection = dao.createDatabaseConnection(connectionConfig);
            if (connection == null) return false;
            String newUser = registrationDialog.getUsernameTextField().getText();
            String userText = "user";
            ...
            String fullName = registrationDialog.getFullNameTextField().getText();
            String address = registrationDialog.getAddressTextField().getText();
            String email = registrationDialog.getEmailTextField().getText();
    ...
    public void doSaveDB() {
        ...
        try {
            ...
            connection = dao.createDatabaseConnection(connectionConfig);
            if (connection == null || statement == null) return;
    ...
    public void getSourceComments(boolean loadExisting) {
        ...
        if (loadExisting) {
            sourceDialog.getSourceText().setText(argument.getSource());
            sourceDialog.getSourceText().setText(argument.getComments());
        }
        sourceDialog.setVisible(true);
        if (!sourceDialog.isOkPressed()) {
            return;
        }
        argument.setSource(sourceDialog.getSourceText().getText());
        if (argument.getSource().length() < 1) {
            argument.setSource("");
        }
        argument.setComments(sourceDialog.getCommentsText().getText());
    ...
    void doSearchDB() {
        ...
        // but offset slightly from the main main.java.Araucaria window
    ...
    void doTextSearchOnDB(String text, String startTag, String endTag,
        ...
        try {
            ConnectionConfig connectionConfig = displayLoginDialogAndBuildConfig();
            Connection connection = dao.createDatabaseConnection(connectionConfig);
            if (connection == null || statement == null) return;
            String userText = "user";
            if (DatabaseType.SQLSERVER.equals(databaseType)) {
                userText = "[user]";
    ...
    public int doTreeSearch(Tree patternTree,
        ...
        try {
            ...
            Connection connection = dao.createDatabaseConnection(connectionConfig);
            if (connection == null || statement == null) return 0;
            String userText = "user";
            if (DatabaseType.SQLSERVER.equals(databaseType)) {
                userText = "[user]";
            }
    ...
    /**
     * Handles events generated by the main.java.Araucaria components. FileActionHandler
...
class RecentFilesMenuItem extends JMenuItem {
    ...
    enum FileType {TEXT, AML, SCHEMESET}
}
