 ...
 * pl.edu.agh.araucaria.SelectText.java
 *
...
public class SelectText extends JPanel implements Serializable {
    ...
    public GeneralPath getSelectedShape() {
        ...
        for (Object aSelectedList : selectedList) {
            Shape shape = (Shape) aSelectedList;
    ...
    /**
     * Assigns shapes in the pl.edu.agh.araucaria.SelectText window for each vertex in the tree.
     *
