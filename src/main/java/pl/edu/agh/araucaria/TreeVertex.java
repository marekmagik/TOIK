...
/**
 * Extends the pl.edu.agh.araucaria.Vertex class to represent nodes in a tree
 */
public class TreeVertex extends Vertex implements Serializable {
    ...
    boolean m_selected;        // pl.edu.agh.araucaria.Vertex is selected (highlighted)
    boolean dummy = false;        // pl.edu.agh.araucaria.Vertex is the dummy root in a split tree
    ...
    /**
     * Adds an edge (with no weight) from the current pl.edu.agh.araucaria.Vertex to destVertex.
     ...
     *
     * @param destVertex The destination pl.edu.agh.araucaria.Vertex for the edge.
    ...
    /**
     * Adds an existing pl.edu.agh.araucaria.TreeEdge - used in undo
     */
    ...
    /**
     * Adds an edge with specified weight from the current pl.edu.agh.araucaria.Vertex to destVertex.
     * Checks if an edge to destVertex already exists,
     * and if not, adds an edge to destVertex. You aren't allowed to
     * have more than one edge from one vertex to another.
     *
     ...
     *
     * @param destVertex The destination pl.edu.agh.araucaria.Vertex.
     * @return The pl.edu.agh.araucaria.Edge object if it exists, null otherwise.
     */
    ...
    /**
     * Returns pl.edu.agh.araucaria.TreeEdge with 'this' as source vertex and
    ...
    public boolean putRefutationFirst() {
        ...
        for (int i = 1; i < m_edgeList.size(); i++) {
            if (((TreeEdge) m_edgeList.elementAt(i)).getDestVertex().isRefutation()) {
                m_edgeList.set(0, m_edgeList.elementAt(i));
