 ...
 * pl.edu.agh.araucaria.gui.panels.FreeVertexPanel.java
 *
...
public class FreeVertexPanel extends DiagramBase {
    /**
     * Creates a new instance of pl.edu.agh.araucaria.gui.panels.FreeVertexPanel
     */
    ...
    protected void drawFreeVertices(Graphics2D gg) {
        ...
        while (freeVertices.hasMoreElements()) {
            ...
            String shortLabelString = vertex.getShortLabelString();
