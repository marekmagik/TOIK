 ...
 * pl.edu.agh.araucaria.gui.panels.DisplayFrame.java
 *
 * Created on 12 April 2004, 11:16
 */

/**
 * Contains a main diagram (derived from pl.edu.agh.araucaria.gui.visualisation.core.DiagramBase) and a pl.edu.agh.araucaria.gui.panels.FreeVertexPanel.
...
public class DisplayFrame extends JPanel {
    ...
    /**
     * controlFrame is the top-level frame containing the pl.edu.agh.araucaria.gui.panels.DisplayFrame.
     * For displays in the main window, this will be the main.java.Araucaria class;
     * for displays in the database search dialog, this will be pl.edu.agh.araucaria.gui.dialogs.SearchFrame
     */
    ...
    /**
     * Creates a new instance of pl.edu.agh.araucaria.gui.panels.DisplayFrame
     */
    public DisplayFrame() {
