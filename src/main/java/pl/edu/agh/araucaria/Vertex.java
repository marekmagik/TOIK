...
/**
 * Represents a pl.edu.agh.araucaria.Vertex in a pl.edu.agh.araucaria.Graph object
 */
public class Vertex implements Serializable {
    ...
    /**
     * Creates a pl.edu.agh.araucaria.Vertex with the specified label.
     *
     * @param label An Object (or derivative) to be used to label this vertex.
     *              pl.edu.agh.araucaria.Vertex labels need not be unique within a graph.
     */
    ...
    /**
     * Creates a clone of the pl.edu.agh.araucaria.Vertex object but with an empty edge list.
     * Used in Kruskal's algorithm, but may be used elsewhere if a pl.edu.agh.araucaria.Vertex
     * must be copied to a different pl.edu.agh.araucaria.Graph, but with different edge connections.
     *
     * @return The cloned pl.edu.agh.araucaria.Vertex.
     */
     ...
     * in square brackets.
     *
     * @param vertexList The vertexList of the pl.edu.agh.araucaria.Graph in which the pl.edu.agh.araucaria.Vertex
     ...
     * Each edge is printed by specifying the label of the destination
     * vertex followed by its index in the graph's vertex list, enclosed
     * in square brackets, followed by the pl.edu.agh.araucaria.Edge's weight, enclosed in
     * angle brackets.
     *
     * @param vertexList The vertexList of the pl.edu.agh.araucaria.Graph in which the pl.edu.agh.araucaria.Vertex
     *                   is contained. This is required in order to obtain the index of
