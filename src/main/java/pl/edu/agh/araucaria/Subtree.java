...
public class Subtree {
     ...
     * pl.edu.agh.araucaria.FullTextPanel.
     */
    ...
    /**
     * Fills a pl.edu.agh.araucaria.SubtreeFrame with info about the subtree.
     * Used to display info when user right clicks on an
     * existing subtree.
     */
  /* TODO: Restore link to pl.edu.agh.araucaria.SubtreeFrame
  public void buildSubtreeFrame(pl.edu.agh.araucaria.SubtreeFrame sFrame)
  {
    ...
    Enumeration edges = m_edgeList.elements();
    while (edges.hasMoreElements()) {
      pl.edu.agh.araucaria.TreeEdge edge = (pl.edu.agh.araucaria.TreeEdge)edges.nextElement();
    ...
    while (edges.hasMoreElements()) {
      pl.edu.agh.araucaria.TreeEdge edge = (pl.edu.agh.araucaria.TreeEdge)edges.nextElement();
      pl.edu.agh.araucaria.TreeVertex source = edge.getSourceVertex();
      pl.edu.agh.araucaria.TreeVertex dest = edge.getDestVertex();
